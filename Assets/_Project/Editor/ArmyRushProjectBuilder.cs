...
public static class ArmyRushProjectBuilder
{
    ...
    private static GlobalTuning CreateTuning()
    {
        ...
        tuning.targetRange = 28f;
        tuning.projectileSpeed = 48f;
        tuning.baseFireInterval = 0.24f;
        tuning.minFireInterval = 0.08f;
        tuning.baseDamage = 10;
        tuning.projectileVisualBurst = 8;
        tuning.muzzleFlashVisualBurst = 6;
        tuning.openingVolleyDamageMultiplier = 1.6f;
        tuning.openingVolleyExtraProjectiles = 4;
        tuning.openingVolleyCooldown = 0.45f;
        tuning.powerSpikeVolleyMinimumGain = 5;
        tuning.powerSpikeVolleyDamageMultiplier = 1.45f;
        tuning.powerSpikeVolleyExtraProjectiles = 3;
        tuning.powerSpikeVolleyCooldown = 0.25f;
        tuning.volleyImmediateDamageFraction = 0.42f;
        tuning.openingVolleyImmediateDamageFraction = 0.64f;
        tuning.onboardingCombatBoostLevelLimit = 3;
        tuning.onboardingCombatBoostDuration = 24f;
        tuning.onboardingCombatDamageMultiplier = 1.35f;
        tuning.onboardingCombatFireRateMultiplier = 1.35f;
        tuning.earlyCloseRangeAssistLevelLimit = 5;
        tuning.closeRangeAssistDistance = 10f;
        tuning.closeRangeFireRateMultiplier = 1.55f;
        tuning.closeRangeDamageMultiplier = 1.25f;
    ...
    private static PrefabSet CreatePrefabs(MaterialSet materials, MeshSet meshes)
    {
        ...
        prefabs.enemyDefeatBurst = CreateParticleVfxPrefab("PF_VFX_EnemyDefeat", new Color(1f, 0.18f, 0.08f), 0.52f, 0.26f, 3.15f, 24, 0.18f, 0.52f, materials.vfxParticle);
    ...
    private static LevelData[] CreateLevels(BossDefinition[] bosses, LevelChunkData[] chunks)
    {
        ...
        for (int i = 1; i <= 20; i++)
        {
            ...
            if (i == 20 && bosses != null && bosses.Length > 1)
            {
                bossDefinition = bosses[1];
            }
    ...
    private static void AddDesignedLevelData(LevelData data, int level, LevelChunkData[] chunks)
    {
        ...
        if (level >= 6 && level <= 9)
        {
            AddLevelSixToNineAdvancedGateData(data, level, chunks);
            return;
        }
        if (level == 10)
        {
        ...
        {
            AddLevelSixteenToNineteenRiskRewardMasteryData(data, level, chunks);
            return;
        }
        if (level == 20)
        {
            AddLevelTwentyMajorBossData(data, chunks);
            return;
        }
    ...
    private static void AddLevelOneTutorialData(LevelData data, LevelChunkData[] chunks)
    {
        ...
        data.enemyGroups.Add(new EnemyGroupSpawnData { z = 46f, x = 0f, count = 8, healthPerUnit = 6, width = 2.4f });
        data.gates.Add(new GateSpawnData { z = 66f, x = 0f, operation = GateOperation.Multiply, value = 2, tutorialHighlight = true });
        AddObstacle(data, 94f, 0f, 40, 4, FindObstacleDefinitionInChunks(chunks, ObstacleKind.CrateStack));
    }
    ...
    private static void AddLevelTwoTutorialData(LevelData data, LevelChunkData[] chunks)
    {
        ...
        data.enemyGroups.Add(new EnemyGroupSpawnData { z = 48f, x = 0f, count = 20, healthPerUnit = 8, width = 2.6f });
        data.gates.Add(new GateSpawnData { z = 68f, x = -1.45f, operation = GateOperation.Multiply, value = 2, tutorialHighlight = true });
        data.gates.Add(new GateSpawnData { z = 68f, x = 1.45f, operation = GateOperation.Add, value = 20 });
        AddObstacle(data, 98f, 0f, 100, 6, FindObstacleDefinitionInChunks(chunks, ObstacleKind.CrateStack));
    }
    ...
    private static void AddLevelThreeTutorialData(LevelData data, LevelChunkData[] chunks)
    {
        ...
        data.enemyGroups.Add(new EnemyGroupSpawnData { z = 50f, x = 0f, count = 25, healthPerUnit = 10, width = 2.8f });
        data.gates.Add(new GateSpawnData { z = 72f, x = -1.45f, operation = GateOperation.Multiply, value = 2, tutorialHighlight = true });
        data.gates.Add(new GateSpawnData { z = 72f, x = 1.45f, operation = GateOperation.Add, value = 30 });
        AddObstacle(data, 104f, 0f, 150, 8, FindObstacleDefinitionInChunks(chunks, ObstacleKind.Barricade));
    }
    ...
    private static void AddLevelSixToNineAdvancedGateData(LevelData data, int level, LevelChunkData[] chunks)
    {
        data.hasBoss = false;
        ...
        switch (level)
        {
            case 6:
                ...
                AddObstacle(data, 82f, 1.35f, 260, 9, FindObstacleDefinitionInChunks(chunks, ObstacleKind.CrateStack));
                data.gates.Add(new GateSpawnData { z = 106f, x = -1.45f, operation = GateOperation.Add, value = 50 });
                data.gates.Add(new GateSpawnData { z = 106f, x = 1.45f, operation = GateOperation.Multiply, value = 2 });
                data.enemyGroups.Add(new EnemyGroupSpawnData { z = 130f, x = 0f, count = 70, healthPerUnit = 14, width = 3.2f });
                break;
            case 7:
                data.trackLength = Mathf.Max(data.trackLength, 158f);
                data.gates.Add(new GateSpawnData { z = 16f, x = -1.45f, operation = GateOperation.Add, value = 35 });
                data.gates.Add(new GateSpawnData { z = 16f, x = 1.45f, operation = GateOperation.Multiply, value = 2 });
                data.enemyGroups.Add(new EnemyGroupSpawnData { z = 38f, x = 0f, count = 40, healthPerUnit = 13, width = 3f });
                data.gates.Add(new GateSpawnData { z = 58f, x = -1.45f, operation = GateOperation.Add, value = 45 });
                ...
                break;
            case 8:
                data.trackLength = Mathf.Max(data.trackLength, 164f);
                data.gates.Add(new GateSpawnData { z = 16f, x = -1.45f, operation = GateOperation.Add, value = 40 });
                data.gates.Add(new GateSpawnData { z = 16f, x = 1.45f, operation = GateOperation.Multiply, value = 2 });
                data.enemyGroups.Add(new EnemyGroupSpawnData { z = 38f, x = 0f, count = 45, healthPerUnit = 14, width = 3.1f });
                data.gates.Add(new GateSpawnData { z = 58f, x = -1.45f, operation = GateOperation.Add, value = 45 });
                data.gates.Add(new GateSpawnData { z = 58f, x = 1.45f, operation = GateOperation.Multiply, value = 2 });
                AddObstacle(data, 82f, -1.35f, 760, 16, FindObstacleDefinitionInChunks(chunks, ObstacleKind.MilitaryTruck));
                AddObstacle(data, 84f, 1.35f, 460, 12, FindObstacleDefinitionInChunks(chunks, ObstacleKind.BarrelCluster));
                data.gates.Add(new GateSpawnData { z = 104f, x = -1.45f, operation = GateOperation.Add, value = 75 });
                data.gates.Add(new GateSpawnData { z = 104f, x = 1.45f, operation = GateOperation.Multiply, value = 3 });
                data.enemyGroups.Add(new EnemyGroupSpawnData { z = 132f, x = 0f, count = 95, healthPerUnit = 16, width = 3.5f });
                break;
            case 9:
                data.trackLength = Mathf.Max(data.trackLength, 174f);
                data.gates.Add(new GateSpawnData { z = 16f, x = -1.45f, operation = GateOperation.Add, value = 35 });
                data.gates.Add(new GateSpawnData { z = 16f, x = 1.45f, operation = GateOperation.Multiply, value = 2 });
                data.enemyGroups.Add(new EnemyGroupSpawnData { z = 38f, x = 0f, count = 48, healthPerUnit = 15, width = 3.1f });
                data.gates.Add(new GateSpawnData { z = 58f, x = -1.45f, operation = GateOperation.Add, value = 30 });
                data.gates.Add(new GateSpawnData { z = 58f, x = 1.45f, operation = GateOperation.Multiply, value = 2 });
                AddObstacle(data, 84f, -1.35f, 520, 13, FindObstacleDefinitionInChunks(chunks, ObstacleKind.ConcreteBlock));
                AddObstacle(data, 84f, 1.35f, 700, 15, FindObstacleDefinitionInChunks(chunks, ObstacleKind.FuelTank));
                data.gates.Add(new GateSpawnData { z = 104f, x = -1.45f, operation = GateOperation.Add, value = 80 });
                data.gates.Add(new GateSpawnData { z = 104f, x = 1.45f, operation = GateOperation.Multiply, value = 3 });
                data.enemyGroups.Add(new EnemyGroupSpawnData { z = 132f, x = 0f, count = 120, healthPerUnit = 17, width = 3.8f });
                data.gates.Add(new GateSpawnData { z = 150f, x = -1.45f, operation = GateOperation.Add, value = 30 });
                data.gates.Add(new GateSpawnData { z = 150f, x = 1.45f, operation = GateOperation.Subtract, value = 30 });
                break;
        }
    }

    private static void AddLevelTenHelicopterBossData(LevelData data, LevelChunkData[] chunks)
    {
        data.trackLength = Mathf.Max(data.trackLength, 184f);
        data.hasBoss = true;
        data.bossHealth = 6000;
        data.gates.Add(new GateSpawnData { z = 16f, x = -1.45f, operation = GateOperation.Add, value = 50 });
        data.gates.Add(new GateSpawnData { z = 16f, x = 1.45f, operation = GateOperation.Multiply, value = 2 });
        data.enemyGroups.Add(new EnemyGroupSpawnData { z = 38f, x = 0f, count = 52, healthPerUnit = 15, width = 3.2f });
        data.gates.Add(new GateSpawnData { z = 58f, x = -1.45f, operation = GateOperation.Add, value = 60 });
        data.gates.Add(new GateSpawnData { z = 58f, x = 1.45f, operation = GateOperation.Multiply, value = 2 });
        AddObstacle(data, 84f, -1.35f, 900, 16, FindObstacleDefinitionInChunks(chunks, ObstacleKind.MilitaryTruck));
        AddObstacle(data, 84f, 1.35f, 760, 14, FindObstacleDefinitionInChunks(chunks, ObstacleKind.Turret));
    ...
    private static void AddLevelSixteenToNineteenRiskRewardMasteryData(LevelData data, int level, LevelChunkData[] chunks)
    {
        data.hasBoss = false;
        data.bossDefinition = null;
        data.bossHealth = 0;
        ...
        {
            case 16:
                data.trackLength = Mathf.Max(data.trackLength, 222f);
                data.gates.Add(new GateSpawnData { z = 16f, x = -1.45f, operation = GateOperation.Add, value = 65 });
                data.gates.Add(new GateSpawnData { z = 16f, x = 1.45f, operation = GateOperation.Multiply, value = 2 });
                data.enemyGroups.Add(new EnemyGroupSpawnData { z = 36f, x = 0f, count = 100, healthPerUnit = 21, width = 4f });
                data.gates.Add(new GateSpawnData { z = 44f, x = -1.45f, operation = GateOperation.Add, value = 40 });
                data.gates.Add(new GateSpawnData { z = 44f, x = 1.45f, operation = GateOperation.Multiply, value = 3 });
                AddObstacle(data, 64f, -1.35f, 1450, 20, FindObstacleDefinitionInChunks(chunks, ObstacleKind.MilitaryTruck));
                AddObstacle(data, 64f, 1.35f, 900, 16, FindObstacleDefinitionInChunks(chunks, ObstacleKind.BarrelCluster));
                data.gates.Add(new GateSpawnData { z = 82f, x = -1.45f, operation = GateOperation.Add, value = 45 });
                data.gates.Add(new GateSpawnData { z = 82f, x = 1.45f, operation = GateOperation.Subtract, value = 40 });
                data.enemyGroups.Add(new EnemyGroupSpawnData { z = 104f, x = 0f, count = 190, healthPerUnit = 22, width = 4.4f });
                AddObstacle(data, 118f, -1.35f, 1500, 20, FindObstacleDefinitionInChunks(chunks, ObstacleKind.Turret));
                AddObstacle(data, 118f, 1.35f, 1050, 16, FindObstacleDefinitionInChunks(chunks, ObstacleKind.ConcreteBlock));
                data.gates.Add(new GateSpawnData { z = 130f, x = -1.45f, operation = GateOperation.Add, value = 30 });
                data.gates.Add(new GateSpawnData { z = 130f, x = 1.45f, operation = GateOperation.Subtract, value = 70 });
                data.enemyGroups.Add(new EnemyGroupSpawnData { z = 158f, x = 0f, count = 230, healthPerUnit = 23, width = 4.6f });
                AddObstacle(data, 176f, -1.35f, 1450, 22, FindObstacleDefinitionInChunks(chunks, ObstacleKind.FuelTank));
                AddObstacle(data, 176f, 1.35f, 900, 14, FindObstacleDefinitionInChunks(chunks, ObstacleKind.Barricade));
                data.enemyGroups.Add(new EnemyGroupSpawnData { z = 196f, x = 0f, count = 260, healthPerUnit = 24, width = 4.8f });
                break;
            case 17:
                data.trackLength = Mathf.Max(data.trackLength, 228f);
                data.gates.Add(new GateSpawnData { z = 16f, x = -1.45f, operation = GateOperation.Add, value = 70 });
                data.gates.Add(new GateSpawnData { z = 16f, x = 1.45f, operation = GateOperation.Multiply, value = 2 });
                data.enemyGroups.Add(new EnemyGroupSpawnData { z = 36f, x = 0f, count = 110, healthPerUnit = 22, width = 4.1f });
                data.gates.Add(new GateSpawnData { z = 44f, x = -1.45f, operation = GateOperation.Add, value = 50 });
                data.gates.Add(new GateSpawnData { z = 44f, x = 1.45f, operation = GateOperation.Multiply, value = 3 });
                AddObstacle(data, 66f, -1.35f, 1550, 21, FindObstacleDefinitionInChunks(chunks, ObstacleKind.MilitaryTruck));
                AddObstacle(data, 66f, 1.35f, 1100, 16, FindObstacleDefinitionInChunks(chunks, ObstacleKind.ConcreteBlock));
                data.gates.Add(new GateSpawnData { z = 84f, x = -1.45f, operation = GateOperation.Add, value = 40 });
                data.gates.Add(new GateSpawnData { z = 84f, x = 1.45f, operation = GateOperation.Subtract, value = 50 });
                data.enemyGroups.Add(new EnemyGroupSpawnData { z = 106f, x = 0f, count = 210, healthPerUnit = 23, width = 4.5f });
                AddObstacle(data, 120f, -1.35f, 1500, 22, FindObstacleDefinitionInChunks(chunks, ObstacleKind.FuelTank));
                AddObstacle(data, 120f, 1.35f, 1550, 21, FindObstacleDefinitionInChunks(chunks, ObstacleKind.Turret));
                data.gates.Add(new GateSpawnData { z = 132f, x = -1.45f, operation = GateOperation.Add, value = 20 });
                data.gates.Add(new GateSpawnData { z = 132f, x = 1.45f, operation = GateOperation.Subtract, value = 80 });
                data.enemyGroups.Add(new EnemyGroupSpawnData { z = 160f, x = 0f, count = 250, healthPerUnit = 24, width = 4.7f });
                AddObstacle(data, 180f, -1.35f, 1700, 22, FindObstacleDefinitionInChunks(chunks, ObstacleKind.MilitaryTruck));
                AddObstacle(data, 180f, 1.35f, 1000, 16, FindObstacleDefinitionInChunks(chunks, ObstacleKind.BarrelCluster));
                data.enemyGroups.Add(new EnemyGroupSpawnData { z = 202f, x = 0f, count = 280, healthPerUnit = 25, width = 4.9f });
                break;
            case 18:
                data.trackLength = Mathf.Max(data.trackLength, 236f);
                data.gates.Add(new GateSpawnData { z = 16f, x = -1.45f, operation = GateOperation.Add, value = 75 });
                data.gates.Add(new GateSpawnData { z = 16f, x = 1.45f, operation = GateOperation.Multiply, value = 2 });
                data.enemyGroups.Add(new EnemyGroupSpawnData { z = 36f, x = 0f, count = 105, healthPerUnit = 21, width = 4.1f });
                data.gates.Add(new GateSpawnData { z = 44f, x = -1.45f, operation = GateOperation.Add, value = 35 });
                data.gates.Add(new GateSpawnData { z = 44f, x = 1.45f, operation = GateOperation.Multiply, value = 3 });
                AddObstacle(data, 66f, -1.35f, 1600, 22, FindObstacleDefinitionInChunks(chunks, ObstacleKind.FuelTank));
                AddObstacle(data, 66f, 1.35f, 1650, 22, FindObstacleDefinitionInChunks(chunks, ObstacleKind.Turret));
                data.gates.Add(new GateSpawnData { z = 86f, x = -1.45f, operation = GateOperation.Add, value = 35 });
                data.gates.Add(new GateSpawnData { z = 86f, x = 1.45f, operation = GateOperation.Subtract, value = 60 });
                data.enemyGroups.Add(new EnemyGroupSpawnData { z = 108f, x = 0f, count = 230, healthPerUnit = 23, width = 4.6f });
                AddObstacle(data, 124f, -1.35f, 1850, 23, FindObstacleDefinitionInChunks(chunks, ObstacleKind.MilitaryTruck));
                AddObstacle(data, 124f, 1.35f, 1250, 17, FindObstacleDefinitionInChunks(chunks, ObstacleKind.ConcreteBlock));
                data.gates.Add(new GateSpawnData { z = 136f, x = -1.45f, operation = GateOperation.Add, value = 10 });
                data.gates.Add(new GateSpawnData { z = 136f, x = 1.45f, operation = GateOperation.Subtract, value = 90 });
                data.enemyGroups.Add(new EnemyGroupSpawnData { z = 166f, x = 0f, count = 275, healthPerUnit = 24, width = 4.8f });
                AddObstacle(data, 188f, -1.35f, 1750, 23, FindObstacleDefinitionInChunks(chunks, ObstacleKind.FuelTank));
                AddObstacle(data, 188f, 1.35f, 1100, 17, FindObstacleDefinitionInChunks(chunks, ObstacleKind.BarrelCluster));
                data.enemyGroups.Add(new EnemyGroupSpawnData { z = 210f, x = 0f, count = 300, healthPerUnit = 25, width = 5f });
                break;
            case 19:
                data.trackLength = Mathf.Max(data.trackLength, 242f);
                data.gates.Add(new GateSpawnData { z = 16f, x = -1.45f, operation = GateOperation.Add, value = 80 });
                data.gates.Add(new GateSpawnData { z = 16f, x = 1.45f, operation = GateOperation.Multiply, value = 2 });
                data.enemyGroups.Add(new EnemyGroupSpawnData { z = 36f, x = 0f, count = 120, healthPerUnit = 22, width = 4.2f });
                data.gates.Add(new GateSpawnData { z = 44f, x = -1.45f, operation = GateOperation.Add, value = 30 });
                data.gates.Add(new GateSpawnData { z = 44f, x = 1.45f, operation = GateOperation.Multiply, value = 3 });
                AddObstacle(data, 66f, -1.35f, 1700, 23, FindObstacleDefinitionInChunks(chunks, ObstacleKind.MilitaryTruck));
                AddObstacle(data, 66f, 1.35f, 1650, 23, FindObstacleDefinitionInChunks(chunks, ObstacleKind.FuelTank));
                data.gates.Add(new GateSpawnData { z = 88f, x = -1.45f, operation = GateOperation.Add, value = 20 });
                data.gates.Add(new GateSpawnData { z = 88f, x = 1.45f, operation = GateOperation.Subtract, value = 70 });
                data.enemyGroups.Add(new EnemyGroupSpawnData { z = 110f, x = 0f, count = 245, healthPerUnit = 24, width = 4.7f });
                AddObstacle(data, 126f, -1.35f, 1800, 23, FindObstacleDefinitionInChunks(chunks, ObstacleKind.Turret));
                AddObstacle(data, 126f, 1.35f, 1350, 18, FindObstacleDefinitionInChunks(chunks, ObstacleKind.ConcreteBlock));
                data.gates.Add(new GateSpawnData { z = 138f, x = -1.45f, operation = GateOperation.Add, value = 10 });
                data.gates.Add(new GateSpawnData { z = 138f, x = 1.45f, operation = GateOperation.Subtract, value = 100 });
                data.enemyGroups.Add(new EnemyGroupSpawnData { z = 170f, x = 0f, count = 290, healthPerUnit = 25, width = 4.9f });
                AddObstacle(data, 194f, -1.35f, 1950, 24, FindObstacleDefinitionInChunks(chunks, ObstacleKind.MilitaryTruck));
                AddObstacle(data, 194f, 1.35f, 1800, 23, FindObstacleDefinitionInChunks(chunks, ObstacleKind.FuelTank));
                data.enemyGroups.Add(new EnemyGroupSpawnData { z = 216f, x = 0f, count = 320, healthPerUnit = 25, width = 5f });
                break;
        }
    }

    private static void AddLevelTwentyMajorBossData(LevelData data, LevelChunkData[] chunks)
    {
        data.trackLength = Mathf.Max(data.trackLength, 252f);
        data.hasBoss = true;
        data.bossHealth = 14500;
        data.gates.Add(new GateSpawnData { z = 16f, x = -1.45f, operation = GateOperation.Add, value = 85 });
        data.gates.Add(new GateSpawnData { z = 16f, x = 1.45f, operation = GateOperation.Multiply, value = 2 });
        data.enemyGroups.Add(new EnemyGroupSpawnData { z = 38f, x = 0f, count = 125, healthPerUnit = 23, width = 4.2f });
        data.gates.Add(new GateSpawnData { z = 58f, x = -1.45f, operation = GateOperation.Add, value = 70 });
        data.gates.Add(new GateSpawnData { z = 58f, x = 1.45f, operation = GateOperation.Multiply, value = 3 });
        AddObstacle(data, 84f, -1.35f, 1800, 24, FindObstacleDefinitionInChunks(chunks, ObstacleKind.MilitaryTruck));
        AddObstacle(data, 84f, 1.35f, 1700, 22, FindObstacleDefinitionInChunks(chunks, ObstacleKind.Turret));
        data.gates.Add(new GateSpawnData { z = 112f, x = -1.45f, operation = GateOperation.Add, value = 15 });
        data.gates.Add(new GateSpawnData { z = 112f, x = 1.45f, operation = GateOperation.Subtract, value = 70 });
        data.enemyGroups.Add(new EnemyGroupSpawnData { z = 132f, x = 0f, count = 255, healthPerUnit = 24, width = 4.8f });
        AddObstacle(data, 160f, -1.35f, 1900, 24, FindObstacleDefinitionInChunks(chunks, ObstacleKind.FuelTank));
        AddObstacle(data, 160f, 1.35f, 2000, 24, FindObstacleDefinitionInChunks(chunks, ObstacleKind.MilitaryTruck));
        data.enemyGroups.Add(new EnemyGroupSpawnData { z = 190f, x = 0f, count = 310, healthPerUnit = 25, width = 5f });
    }
    ...
    private static void ValidateCombatTuning(List<string> failures)
    {
        ...
        if (tuning.openingVolleyExtraProjectiles < 4)
        {
        ...
        if (tuning.powerSpikeVolleyDamageMultiplier < 1.35f || tuning.powerSpikeVolleyDamageMultiplier > tuning.openingVolleyDamageMultiplier)
        {
        ...
        if (tuning.powerSpikeVolleyExtraProjectiles < 3 || tuning.powerSpikeVolleyExtraProjectiles > tuning.openingVolleyExtraProjectiles)
        {
        ...
        if (tuning.volleyImmediateDamageFraction < 0.38f || tuning.volleyImmediateDamageFraction > 0.5f)
        {
            failures.Add("Volley immediate damage fraction should make combat responsive while preserving projectile impact value.");
        }
        if (tuning.openingVolleyImmediateDamageFraction < 0.6f || tuning.openingVolleyImmediateDamageFraction > 0.7f)
        {
        ...
        if (tuning.onboardingCombatBoostDuration < 20f || tuning.onboardingCombatBoostDuration > 30f)
        {
            failures.Add("Onboarding combat boost duration should cover the first enemy and obstacle beats without covering full runs.");
        }
        if (tuning.onboardingCombatDamageMultiplier < 1.3f || tuning.onboardingCombatDamageMultiplier > 1.45f)
        {
            failures.Add("Onboarding combat damage boost should make the opener feel powerful without replacing upgrades.");
        }
        if (tuning.onboardingCombatFireRateMultiplier < 1.3f || tuning.onboardingCombatFireRateMultiplier > 1.45f)
        {
        ...
        if (tuning.closeRangeFireRateMultiplier < 1.45f || tuning.closeRangeFireRateMultiplier > 1.75f)
        {
            failures.Add("Close-range combat fire-rate assist should make imminent contact feel urgent without replacing upgrades.");
        }
        if (tuning.closeRangeDamageMultiplier < 1.2f || tuning.closeRangeDamageMultiplier > 1.35f)
        {
    ...
    private static void ValidateEarlyCombatOnboarding(List<string> failures)
    {
        ...
        foreach (LevelData level in levels)
        {
            ...
            GateSpawnData firstGate = level.gates != null
                ? level.gates.Where(gate => gate != null && gate.z < firstEnemy.z - 0.1f).OrderBy(gate => gate.z).FirstOrDefault()
                : null;
            if (firstGate != null)
            {
                float targetLockZ = Mathf.Max(0f, firstEnemy.z - Mathf.Max(0f, tuning.targetRange));
                if (targetLockZ < firstGate.z + 2f)
                {
                    failures.Add(level.name + " first enemy target lock should start after the opening growth gate so physical-device onboarding reads as grow-before-fight.");
                }
            }
            ...
            if (estimate.DamageBeforeContact < enemyHealth)
            {
                failures.Add(level.name + " first enemy should clear before physical contact during onboarding; estimate deals " + estimate.DamageBeforeContact + "/" + enemyHealth + " damage before contact.");
            }
    ...
    private static void ValidateLevelDataAssets(List<string> failures)
    {
        ...
        foreach (LevelData level in levels)
        {
            ...
            else if (level.levelIndex >= 6 && level.levelIndex <= 9)
            {
                ValidateLevelSixToNineAdvancedGateLayout(failures, level, label, defaultStartingSoldiers);
            }
            else if (level.levelIndex == 10)
            {
            ...
            else if (level.levelIndex >= 16 && level.levelIndex <= 19)
            {
                ValidateLevelSixteenToNineteenRiskRewardMasteryLayout(failures, level, label, defaultStartingSoldiers);
            }
            else if (level.levelIndex == 20)
            {
                ValidateLevelTwentyMajorBossLayout(failures, level, label, defaultStartingSoldiers);
            }
    ...
    {
        return level != null && level.levelIndex >= 1 && level.levelIndex <= 20 && (level.chunks == null || level.chunks.Count == 0);
    }
    ...
    private static void ValidateLevelOneTutorialLayout(List<string> failures, LevelData level, string label)
    {
        ...
        bool hasHighlightedPostEnemyX2 = firstEnemy != null && gates.Any(gate => gate.tutorialHighlight && gate.z > firstEnemy.z + 0.1f && gate.z < firstObstacleZ - 0.1f && gate.operation == GateOperation.Multiply && gate.value == 2);
        if (!hasHighlightedPostEnemyX2)
        {
    ...
    private static void ValidateLevelTwoTutorialLayout(List<string> failures, LevelData level, string label)
    {
        ...
        float firstObstacleZ = obstacles.Count > 0 ? obstacles[0].z : float.MaxValue;
        bool hasRecoveryX2 = firstEnemy != null && gates.Any(gate => gate.z > firstEnemy.z + 0.1f && gate.z < firstObstacleZ - 0.1f && gate.operation == GateOperation.Multiply && gate.value == 2);
        bool hasRecoveryAdd = firstEnemy != null && gates.Any(gate => gate.z > firstEnemy.z + 0.1f && gate.z < firstObstacleZ - 0.1f && gate.operation == GateOperation.Add && gate.value == 20);
        if (!hasRecoveryX2 || !hasRecoveryAdd)
        {
            failures.Add(label + " must present the documented x2 vs +20 recovery choice.");
        }
        bool hasHighlightedRecoveryX2 = firstEnemy != null && gates.Any(gate => gate.tutorialHighlight && gate.z > firstEnemy.z + 0.1f && gate.z < firstObstacleZ - 0.1f && gate.operation == GateOperation.Multiply && gate.value == 2);
        if (!hasHighlightedRecoveryX2)
        {
    ...
    private static void ValidateLevelThreeTutorialLayout(List<string> failures, LevelData level, string label)
    {
        ...
        float firstObstacleZ = obstacles.Count > 0 ? obstacles[0].z : float.MaxValue;
        bool hasFollowUpX2 = firstEnemy != null && gates.Any(gate => gate.z > firstEnemy.z + 0.1f && gate.z < firstObstacleZ - 0.1f && gate.operation == GateOperation.Multiply && gate.value == 2);
        bool hasFollowUpAdd = firstEnemy != null && gates.Any(gate => gate.z > firstEnemy.z + 0.1f && gate.z < firstObstacleZ - 0.1f && gate.operation == GateOperation.Add && gate.value == 30);
        if (!hasFollowUpX2 || !hasFollowUpAdd)
        {
            failures.Add(label + " must present the documented x2 vs +30 follow-up choice.");
        }
        bool hasHighlightedFollowUpX2 = firstEnemy != null && gates.Any(gate => gate.tutorialHighlight && gate.z > firstEnemy.z + 0.1f && gate.z < firstObstacleZ - 0.1f && gate.operation == GateOperation.Multiply && gate.value == 2);
        if (!hasHighlightedFollowUpX2)
        {
    ...
    private static void ValidateLevelSixToNineAdvancedGateLayout(List<string> failures, LevelData level, string label, int defaultStartingSoldiers)
    {
        if (level.chunks != null && level.chunks.Count > 0)
        {
            failures.Add(label + " should use direct authored spawns so the post-first-boss advanced gate ramp stays readable.");
        }
        if (level.hasBoss)
        {
            failures.Add(label + " should be an advanced gate/combat level, not a boss level.");
        }
        ...
        int requiredGateCount = level.levelIndex == 9 ? 8 : 6;
        if (gates.Count < requiredGateCount)
        {
            failures.Add(label + " needs enough gate decisions for the advanced post-boss ramp.");
        }
        if (!HasGate(gates, 16f, GateOperation.Add, level.levelIndex >= 8 ? 40 : 35) && !HasGate(gates, 16f, GateOperation.Add, 35))
        {
            failures.Add(label + " should open with a generous additive gate after the first boss.");
        }
        if (!gates.Any(gate => gate.operation == GateOperation.Multiply && gate.value == 2))
        {
            failures.Add(label + " must keep x2 growth readable in the advanced ramp.");
        }
        if (level.levelIndex >= 8 && !gates.Any(gate => gate.operation == GateOperation.Multiply && gate.value == 3))
        {
            failures.Add(label + " must introduce x3 advanced-gate excitement by Level 8.");
        }
        if (level.levelIndex == 7 && !gates.Any(gate => gate.operation == GateOperation.Subtract && gate.value == 20))
        {
            failures.Add(label + " should refresh negative-gate avoidance with a safe -20 contrast.");
        }
        if (level.levelIndex == 9 && !gates.Any(gate => gate.operation == GateOperation.Subtract && gate.value == 30))
        {
        ...
        if (enemies.Count < 2)
        {
            failures.Add(label + " must include a warmup enemy and a power-spend enemy.");
        }
        else
        {
            EnemyGroupSpawnData firstEnemy = enemies.First();
            EnemyGroupSpawnData finalEnemy = enemies.Last();
            if (firstEnemy.count < 35 || firstEnemy.healthPerUnit > 15)
            {
                failures.Add(label + " first enemy should stay readable and fair after the opening gate.");
            }
            if (finalEnemy.count < 65 || finalEnemy.healthPerUnit > 18)
            {
                failures.Add(label + " final enemy should spend the grown army without becoming punishing.");
            }
        }

        if (obstacles.Count < 2)
        {
            failures.Add(label + " must include an advanced obstacle choice.");
        }
        if (!obstacles.Any(IsAdvancedObstacle))
        {
            failures.Add(label + " should use advanced obstacle silhouettes after Level 5.");
        }

        int bestCount = EstimateBestGatePath(level, defaultStartingSoldiers);
        if (bestCount > 300)
        {
            failures.Add(label + " best gate path should not exceed the current logical soldier hard cap before the finish.");
        }
        if (level.trackLength < 150f)
        {
            failures.Add(label + " needs enough length for advanced gates, combat, and recovery beats.");
        }
    }

    private static void ValidateLevelTenHelicopterBossLayout(List<string> failures, LevelData level, string label, int defaultStartingSoldiers)
    {
        if (level.chunks != null && level.chunks.Count > 0)
        {
            failures.Add(label + " should use direct authored spawns so the first true boss ramp stays clean.");
        }
        if (!level.hasBoss || level.bossDefinition == null || level.bossDefinition.attackPattern != BossAttackPattern.MissileStrike)
        {
            failures.Add(label + " must be the first true helicopter boss milestone.");
        }
        if (level.bossHealth < 5200 || level.bossHealth > 7000)
        {
            failures.Add(label + " true boss health should create a visible fight against the post-Level-5 army power curve.");
        }
        ...
        if (!HasGate(gates, 16f, GateOperation.Add, 50) || !HasGate(gates, 16f, GateOperation.Multiply, 2))
        {
            failures.Add(label + " must open the true-boss level with a strong +50 vs x2 decision.");
        }
        if (!HasGate(gates, 58f, GateOperation.Add, 60) || !HasGate(gates, 58f, GateOperation.Multiply, 2))
        {
            failures.Add(label + " must include a second boss-prep power gate.");
        }
        ...
        {
            failures.Add(label + " needs a warmup enemy and a stronger pre-boss enemy.");
        }
        ...
        {
            failures.Add(label + " should stage a truck/turret obstacle check before the helicopter boss.");
        }
        if (EstimateBestGatePath(level, defaultStartingSoldiers) > 300)
        {
            failures.Add(label + " best gate path should stay within the current logical soldier hard cap before the boss.");
        }
        if (GetBossApproachStart(level) < 136f)
        {
            failures.Add(label + " needs enough final approach space for the helicopter boss health bar and telegraph setup.");
        }
    }

    private static bool IsAdvancedObstacle(ObstacleSpawnData obstacle)
    {
        ...
        ObstacleKind kind = obstacle.definition.kind;
        return kind == ObstacleKind.BarrelCluster ||
    ...
    private static void ValidateLevelSixteenToNineteenRiskRewardMasteryLayout(List<string> failures, LevelData level, string label, int defaultStartingSoldiers)
    {
        if (level.chunks != null && level.chunks.Count > 0)
        {
            failures.Add(label + " should use direct authored spawns so the mastery ramp can be tuned for fair risk/reward pressure.");
        }
        if (level.hasBoss)
        {
            failures.Add(label + " should spend the Level 15 power gain before the Level 20 major boss, not spawn a boss.");
        }
        ...
        if (gates.Count < 8)
        {
            failures.Add(label + " needs at least four paired mastery gate decisions.");
        }
        if (!gates.Any(gate => gate.operation == GateOperation.Multiply && gate.value == 3))
        {
            failures.Add(label + " must include a readable x3 mastery route.");
        }
        if (!gates.Any(gate => gate.operation == GateOperation.Subtract && gate.value >= 60))
        {
            failures.Add(label + " must include a high-risk negative route without forcing it.");
        }

        if (enemies.Count < 4)
        {
            failures.Add(label + " must include a warmup wave, two spend waves, and a final elite wave.");
        }
        else
        {
            EnemyGroupSpawnData firstEnemy = enemies.First();
            EnemyGroupSpawnData finalEnemy = enemies.Last();
            if (firstEnemy.count < 100 || firstEnemy.healthPerUnit > 24)
            {
                failures.Add(label + " first mastery enemy should be large but still readable after the opener.");
            }
            if (finalEnemy.count < 250 || finalEnemy.healthPerUnit > 26)
            {
                failures.Add(label + " final mastery enemy should feel elite without becoming an upgrade wall.");
            }
        }

        if (obstacles.Count < 6)
        {
            failures.Add(label + " must include heavy obstacle route pressure.");
        }
        if (!obstacles.Any(obstacle => obstacle.definition != null && obstacle.definition.kind == ObstacleKind.MilitaryTruck) ||
            !obstacles.Any(obstacle => obstacle.definition != null && obstacle.definition.kind == ObstacleKind.Turret) ||
            !obstacles.Any(obstacle => obstacle.definition != null && obstacle.definition.kind == ObstacleKind.FuelTank))
        {
            failures.Add(label + " must rotate truck, turret, and fuel-tank silhouettes during mastery levels.");
        }
        if (obstacles.Any(obstacle => obstacle.collisionPenalty > 24))
        {
            failures.Add(label + " mastery obstacle penalties should stay punishing but not retention-breaking.");
        }

        int bestCount = EstimateBestGatePath(level, defaultStartingSoldiers);
        if (bestCount < 290 || bestCount > 300)
        {
            failures.Add(label + " best gate path should reach the upper power band without exceeding the hard cap.");
        }
        if (level.trackLength < 220f)
        {
            failures.Add(label + " needs enough length for mastery gates, elite waves, heavy obstacles, and recovery reads.");
        }
    }

    private static void ValidateLevelTwentyMajorBossLayout(List<string> failures, LevelData level, string label, int defaultStartingSoldiers)
    {
        if (level.chunks != null && level.chunks.Count > 0)
        {
            failures.Add(label + " should use direct authored spawns so the Level 20 boss milestone stays readable.");
        }
        if (!level.hasBoss || level.bossDefinition == null || level.bossDefinition.attackPattern != BossAttackPattern.MissileStrike)
        {
            failures.Add(label + " must be a major helicopter boss milestone per the documented Level 20 progression target.");
        }
        if (level.bossHealth < 13000 || level.bossHealth > 17000)
        {
            failures.Add(label + " major boss health should create a real fight without stalling the session.");
        }
        ...
        if (!HasGate(gates, 16f, GateOperation.Add, 85) || !HasGate(gates, 16f, GateOperation.Multiply, 2))
        {
            failures.Add(label + " must open with a strong +85 vs x2 milestone choice.");
        }
        if (!HasGate(gates, 58f, GateOperation.Add, 70) || !HasGate(gates, 58f, GateOperation.Multiply, 3))
        {
            failures.Add(label + " must offer a major x3 power route before the boss gauntlet.");
        }
        if (!HasGate(gates, 112f, GateOperation.Add, 15) || !HasGate(gates, 112f, GateOperation.Subtract, 70))
        {
            failures.Add(label + " must include a final readable recovery-vs-danger gate before the boss lead-in.");
        }

        if (enemies.Count < 3 || enemies.First().count < 120 || enemies.Last().count < 300)
        {
            failures.Add(label + " needs a large warmup, elite pre-boss spend wave, and final boss-gate wave.");
        }
        if (!obstacles.Any(obstacle => obstacle.definition != null && obstacle.definition.kind == ObstacleKind.MilitaryTruck) ||
            !obstacles.Any(obstacle => obstacle.definition != null && obstacle.definition.kind == ObstacleKind.Turret) ||
            !obstacles.Any(obstacle => obstacle.definition != null && obstacle.definition.kind == ObstacleKind.FuelTank))
        {
            failures.Add(label + " must stage truck, turret, and fuel-tank pressure before the major boss.");
        }
        if (obstacles.Any(obstacle => obstacle.collisionPenalty > 24))
        {
            failures.Add(label + " pre-major-boss obstacle penalties should stay survivable.");
        }

        int bestCount = EstimateBestGatePath(level, defaultStartingSoldiers);
        if (bestCount < 295 || bestCount > 300)
        {
            failures.Add(label + " best gate path should reach the hard-cap power fantasy before the major boss.");
        }
        if (GetBossApproachStart(level) < 206f)
        {
            failures.Add(label + " needs a long, clean final approach for the major boss health bar and missile telegraphs.");
        }
    }
    ...
    private sealed class PrefabSet
    {
        ...
        public GameObject enemyDefeatBurst;
